...
// dereference" dentro de Generate. Ver tasks/NEWS.md, defeito BUG-03.
...
// dereference". Ver tasks/NEWS.md, defeito BUG-03.
...
// Ver tasks/NEWS.md, item PERF-01.
...
// indireta. Ver tasks/REPORT.md, item MEL-7.
