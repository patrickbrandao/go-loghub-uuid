...
// documentação do projeto afirma, em docs/SPEC.md seção 4.2 e no
// CLAUDE.md, que o outro pacote pode repetir um UUIDv1 ao voltar a uma
// sequência de relógio já usada, enquanto esta biblioteca não. É uma
// afirmação factual sobre software alheio, usada como diferencial, e
// merece prova executável em vez de prosa.
//
